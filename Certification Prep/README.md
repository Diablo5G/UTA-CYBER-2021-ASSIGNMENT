...
-  6 Authorization to Test Emails from Pearson VUE sent to you after the registration completed for the test taker
      ...
      -  Exam: SPLK-1004 - Splunk Core Certified Advanced Power User
...
**Notes:** In each of them will provide a difference of **Client Authorization ID** and the **Test Length:	‎60‎ Minutes‎** :alarm_clock:
